...
DATA_DIR="/home/jeff/git/fpe-model/experiments/20250106-multisite/runs/${RUN}/input"
OUTPUT_DIR="/home/jeff/git/fpe-model/experiments/20250106-multisite/runs/${RUN}/output"
