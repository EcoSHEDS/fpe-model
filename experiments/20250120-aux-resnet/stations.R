# export station dataset for given station and variable
# usage: Rscript station-dataset.R --help
# example: Rscript station-dataset.R -d /mnt/d/fpe/stations -s 29 -v FLOW_CFS -m 65
